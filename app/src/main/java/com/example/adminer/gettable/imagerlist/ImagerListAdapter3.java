...
public class ImagerListAdapter3 extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    public ImagerListAdapter3(Context context, String[] imageThumbUrls, PullToRefreshListView listView) {
